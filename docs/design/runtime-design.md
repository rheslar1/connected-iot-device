# Connected IoT Device Runtime Design
...
1. Build a runtime profile for `connected-iot-device`.
...
The runtime must make this focus measurable through logs, reports, tests, diagrams, or hardware captures. The proof point for review is: End-to-end connected-device architecture, secure cloud messaging, field-update readiness, and measured battery-aware behavior.
