...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Connected IoT Device. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: RTOS-based sensor node with MQTT cloud integration, signed OTA updates, low-power operating modes, and TLS-backed device identity. | Scenario tests and documentation review. |
