# Connected IoT Device Deep Architecture
...
C++17, C++ Design Patterns, SOLID, FreeRTOS/Zephyr, MQTT, TLS, OTA, Low power modes, Device identity
...
- Source boundary: `include, src`
- Executable entry: `src/main.cpp`
- Test coverage: `tests/ProjectRuntimeTests.cpp`
