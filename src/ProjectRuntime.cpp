...
ProjectProfile demoProfile() {
  return ProjectProfile{
      ...
      MetricSpec{"bus_latency_ms", "ms", 120.0, true},
      MetricSpec{"decode_errors", "count", 1.0, true},
      true};
}

RuntimeSample nominalSample() {
  return RuntimeSample{1U, 54.0, 0.45, true, "host-ci-nominal"};
}

RuntimeSample unsafeSample() {
  return RuntimeSample{2U, 162.0, 3.0, true, "host-ci-limit-test"};
}

RuntimeSample offlineSample() {
  return RuntimeSample{3U, 54.0, 0.45, false, "host-ci-offline"};
}
